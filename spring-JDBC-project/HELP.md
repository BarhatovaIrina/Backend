...
* The original package name 'com.example.spring-JDBC-project' is invalid and this project uses 'com.example.springJDBCproject' instead.
...
* [Spring Data JDBC](https://docs.spring.io/spring-boot/docs/3.0.11/reference/htmlsingle/index.html#data.sql.jdbc)
